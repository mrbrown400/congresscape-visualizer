...
| Daily Briefing | `backend/app/services/daily_summary_service.py`, `backend/app/api/routes/summary.py`, `frontend/src/features/dailyBrief/`, `frontend/src/features/today/` | `docs/architecture.md` | Backend tests, TypeScript, Expo web or Browser smoke |
...
- Summary and feed ranking currently share placeholder personalization logic.
